...
public class StickyNoteData {
    ...
    public StickyNoteData(String stickynoteId, String boardId, String content, double positionX, double positionY, int fontSize, int shapeKind, double width, double height, String color) {
